...
class AlienInvasion:
    ...
    def __init__(self):
        """Инициализация игры и создание игровых процессов."""
        pygame.init()
...
#            (self.settings.screen_width, self.settings.screen_height))
        ...
        # Создание экземпляра для сохранения игровой статистики.
    ...
    def _update_aliens(self):
        """Проверяет достиг ли флот края экрана и обновляет позиции все пришельцев во флоте."""
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = alien.rect.height + 2 * alien.rect.height * (row_number - 1) # Корректировка числа строк пришельцев.
